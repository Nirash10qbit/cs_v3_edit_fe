<template>
  <div>
    ...
    <div :class="containerClass">
      ...
      <b-form 
        :action="routeTo(routes.discussions).fullPath || routeTo(routes.discussions)">
        <div class="row">
          <div class="col-lg-9">
          ...
          <div 
            ...
            <div class="page-section pt-lg-64pt">
              ...
              <div class="page-nav__content">
                <p class="text-70">
                  There may be other students who have asked the same question before.
                </p>
                <p class="text-70">
                  You should do a quick search first to make sure your question is unique.
                </p>
              </div>
            </div>
