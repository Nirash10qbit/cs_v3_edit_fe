    ...
    <docs-page 
      ...
      <card
        ...
        <p class="text-black-70">
          For a soft background, use one of the contextual variants i.e. <code>success</code>.
        </p>
      ...
      <card
        ...
        <b-alert 
          ...
          <p class="mb-1">
            <strong>Well done!</strong> You successfully read this important alert message. This alert will dismiss after {{ dismissCountDown }} seconds...
          </p>
          <b-progress
            :max="dismissSecs"
      ...
      <card
        ...
        footer-class="bg-dark">
        <p class="text-black-70">
          For a stronger background color use the <code>.bg-*</code> and <code>.text-white.border-0</code> classes.
        </p>
