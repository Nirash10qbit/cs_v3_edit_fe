      ...
      <div class="card-body d-flex flex-column">
        <div class="d-flex align-items-center">
          ...
          <b-link 
            ...
            :to="routeTo(to)" 
            class="ml-4pt material-icons text-20 card-course__icon-favorite">favorite<template v-if="!favorite">
              _border
            </template></b-link>
        </div>
        ...
        <template v-if="details">
          ...
          <p class="mt-16pt text-black-70 flex">
            {{ localDescription }}
          </p>
          ...
          <div class="mb-16pt d-none">
            <div class="d-flex align-items-center">
              ...
              <p class="flex text-black-50 lh-1 mb-0">
                <small>Fundamentals of working with {{ title }}</small>
              </p>
            </div>
            <div class="d-flex align-items-center">
              <span class="material-icons icon-16pt text-black-50 mr-8pt">check</span>
              <p class="flex text-black-50 lh-1 mb-0">
                <small>Create complete {{ title }} applications</small>
              </p>
            </div>
            <div class="d-flex align-items-center">
              <span class="material-icons icon-16pt text-black-50 mr-8pt">check</span>
              <p class="flex text-black-50 lh-1 mb-0">
                <small>Working with the {{ title }} CLI</small>
              </p>
            </div>
            <div class="d-flex align-items-center">
              <span class="material-icons icon-16pt text-black-50 mr-8pt">check</span>
            ...
            <div class="d-flex align-items-center">
              <span class="material-icons icon-16pt text-black-50 mr-8pt">check</span>
              <p class="flex text-black-50 lh-1 mb-0">
                <small>Testing with {{ title }}</small>
              </p>
            </div>
          </div>
