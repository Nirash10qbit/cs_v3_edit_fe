    ...
    <template v-if="navbarFullSampleGuestMode">
      <b-navbar-nav
        ...
        <b-nav-item-dropdown
          :text="$t('Courses')"
          no-caret>
          <b-dropdown-item :to="routeTo(routes.studentCourses)">
            {{ $t('Browse Courses') }}
          </b-dropdown-item>
          <b-dropdown-item :to="routeTo(routes.studentCourse)">
            {{ $t('Preview Course') }}
          </b-dropdown-item>
          <b-dropdown-item :to="routeTo(routes.studentLesson)">
            {{ $t('Preview Lesson') }}
          </b-dropdown-item>
          ...
          <b-dropdown-item :to="routeTo(routes.studentTakeLesson)">
            {{ $t('Take Lesson') }}
          </b-dropdown-item>
          <b-dropdown-item :to="routeTo(routes.studentTakeQuiz)">
            {{ $t('Take Quiz') }}
          </b-dropdown-item>
          <b-dropdown-item :to="routeTo(routes.studentQuizResult)">
            {{ $t('Quiz Result') }}
          </b-dropdown-item>
          <b-dropdown-item :to="routeTo(routes.studentDashboard)">
            {{ $t('Student Dashboard') }}
          </b-dropdown-item>
          <b-dropdown-item :to="routeTo(routes.studentMyCourses)">
            {{ $t('My Courses') }}
          </b-dropdown-item>
          <b-dropdown-item :to="routeTo(routes.studentMyQuizzes)">
            {{ $t('My Quizzes') }}
          </b-dropdown-item>
        </b-nav-item-dropdown>
        <b-nav-item-dropdown
          :text="$t('Paths')"
          no-caret>
          <b-dropdown-item :to="routeTo(routes.studentPaths)">
            {{ $t('Browse Paths') }}
          </b-dropdown-item>
          <b-dropdown-item :to="routeTo(routes.studentPath)">
            {{ $t('Path Details') }}
          </b-dropdown-item>
          <b-dropdown-item :to="routeTo(routes.studentSkillAssessment)">
            {{ $t('Skill Assessment') }}
          </b-dropdown-item>
          <b-dropdown-item :to="routeTo(routes.studentSkillResult)">
            {{ $t('Skill Result') }}
          </b-dropdown-item>
          <b-dropdown-item :to="routeTo(routes.studentMyPaths)">
            {{ $t('My Paths') }}
          </b-dropdown-item>
        </b-nav-item-dropdown>
        <b-nav-item :to="routeTo(routes.pricing)">
          {{ $t('Pricing') }}
        </b-nav-item>
        <b-nav-item-dropdown
          :text="$t('Instructor')"
          no-caret>
          <b-dropdown-item :to="routeTo(routes.instructorDashboard)">
            {{ $t('Instructor Dashboard') }}
          </b-dropdown-item>
          <b-dropdown-item :to="routeTo(routes.instructorCourses)">
            {{ $t('Manage Courses') }}
          </b-dropdown-item>
          <b-dropdown-item :to="routeTo(routes.instructorQuizzes)">
            {{ $t('Manage Quizzes') }}
          </b-dropdown-item>
          <b-dropdown-item :to="routeTo(routes.instructorEarnings)">
            {{ $t('Earnings') }}
          </b-dropdown-item>
          <b-dropdown-item :to="routeTo(routes.instructorStatement)">
            {{ $t('Statement') }}
          </b-dropdown-item>
          <b-dropdown-item :to="routeTo(routes.instructorEditCourse)">
            {{ $t('Edit Course') }}
          </b-dropdown-item>
          <b-dropdown-item :to="routeTo(routes.instructorEditQuiz)">
            {{ $t('Edit Quiz') }}
          </b-dropdown-item>
        </b-nav-item-dropdown>
        <b-nav-item-dropdown
          ...
          <b-dropdown-item :to="routeTo(routes.teachers)">
            {{ $t('Browse Teachers') }}
          </b-dropdown-item>
          <b-dropdown-item :to="routeTo(routes.studentProfile)">
            {{ $t('Student Profile') }}
          </b-dropdown-item>
          <b-dropdown-item :to="routeTo(routes.instructorProfile)">
            {{ $t('Instructor Profile') }}
          </b-dropdown-item>
          <b-dropdown-item :to="routeTo(routes.blog)">
            {{ $t('Blog') }}
          </b-dropdown-item>
          <b-dropdown-item :to="routeTo(routes.blogPost)">
            {{ $t('Blog Post') }}
          </b-dropdown-item>
          <b-dropdown-item :to="routeTo(routes.faq)">
            {{ $t('FAQ') }}
          </b-dropdown-item>
          <b-dropdown-item :to="routeTo(routes.helpCenter)">
            {{ $t('Help Center') }}
          </b-dropdown-item>
          <b-dropdown-item :to="routeTo(routes.discussions)">
            {{ $t('Discussions') }}
          </b-dropdown-item>
          <b-dropdown-item :to="routeTo(routes.discussion)">
            {{ $t('Discussion Details') }}
          </b-dropdown-item>
          <b-dropdown-item :to="routeTo(routes.askQuestion)">
            {{ $t('Ask Question') }}
          </b-dropdown-item>
        </b-nav-item-dropdown>
      </b-navbar-nav>
